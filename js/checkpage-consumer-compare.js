...
$(() => {
    ...
    for (i = 0; i < 113; i++) {
        ...
        if (i < 5) {
            ...
            // }
            tttt = '<span class="layui-badge-dot layui-bg-orange" style="margin-right:10px"></span>' + tttt + '<span style="display:inline-block;width:10px;margin-left:10px;"></span>';
        }
    ...
    let ttitle = ' 测试时间：<span  class="text-show">2021-04-24 10:30:06</span> <b>（已审核）</b>';
    OpenDuiBi(ttitle);
